            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">{{ __('Update organization') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('Update organization') }}</h4>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="col-12">
                                        <form id="account_form" method="post" action="#" class="form-horizontal">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="file"
                                                           @change="onFileSelected" id="logo" name="logo"
                                                           accept="image/" hidden>
                                            ...
                                            <div class="row mb-3 mt-3 mx-4">
                                                <div class="form-check my-1"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label"
                                                                   for="supplier_profile_id">{{ __('Profile id') }}</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label"
                                                                   for="supplier_merchant_identifier">{{ __('Merchant Identifier') }}</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label"
                                                                   for="supplier_sha_request_phrase">{{ __('SHA request phrase') }}</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label"
                                                                   for="supplier_sha_response_phrase">{{ __('SHA response phrase') }}</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="supplier_pay_integration_url">{{ __('Pay Integration URL') }}</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" v-model="supplier.supplier_pay_integration_url" id="supplier_pay_integration_url" name="supplier_pay_integration_url">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="supplier_refund_integration_url">{{ __('Refund Integration URL') }}</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" v-model="supplier.supplier_refund_integration_url" id="supplier_refund_integration_url" name="supplier_refund_integration_url">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label"
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                payment_type: @json($organization->paymentTypes()->get()->pluck('id')->toArray()),
                suppliers: @json($organization->suppliers()->get()->pluck('supplier_id')->toArray()),
                methods: @json($organization->paymentMethod()->get()->pluck('id')->toArray()),
                supplier_settings: [],
                settings: @json($organization->suppliers()->get()),
                all_suppliers: @json($suppliers),
                errors: null,
                currencies: @json(getCurrencies())
            },
            mounted: function () {
                this.prepareSupplierSettings()
            },
            methods: {
                ...
                submitOrganization: function () {
                    axios.put('{{ route('organization.update', $organization->id) }}',
                        {
                ...
                prepareSupplierSettings: function () {
                    let getSupplier, object;
                    this.supplier_settings = [];
                    for (let supplier of this.suppliers) {
                        getSupplier = null;
                        object = null;
                        for (let setting of this.settings) {
                            if (JSON.parse(setting.settings).supplier_id == supplier) {
                                getSupplier = JSON.parse(setting.settings);
                            }
                        }
                        if (getSupplier) {
                            let object = {
                                supplier_currency : getSupplier.supplier_currency,
                                supplier_id : getSupplier.supplier_id,
                                name : getSupplier.name,
                                supplier_name : getSupplier.name,
                                supplier_server_key : getSupplier.supplier_server_key,
                                supplier_profile_id : getSupplier.supplier_profile_id,
                                supplier_sha_response_phrase : getSupplier.supplier_sha_response_phrase,
                                supplier_sha_request_phrase : getSupplier.supplier_sha_request_phrase,
                                supplier_merchant_identifier : getSupplier.supplier_merchant_identifier,
                                supplier_access_code : getSupplier.supplier_access_code,
                                supplier_pay_integration_url : getSupplier.supplier_pay_integration_url,
                                supplier_refund_integration_url : getSupplier.supplier_refund_integration_url,
                                supplier_api_key : getSupplier.supplier_api_key,
                                supplier_provider_key : getSupplier.supplier_provider_key,
                                env_type : getSupplier.env_type
                            };
                            ...
                            for (let sup of this.all_suppliers) {
                                if (sup.id == supplier) {
                                    let object = {
                                        ...
                                        supplier_refund_integration_url: null,
                                        supplier_api_key : null,
                                        supplier_provider_key : null,
                                        env_type: null
                                    };
                                    this.supplier_settings.push(object);
                                    break;
